...
class WindowMain:
    ...
    def create_layout_edit_event():
        ...
        sg_right_column = [
            ...
            [sg.Combo([''], key='-EDIT_EVENT_TEAM-', expand_x=True, readonly=True, enable_events=True, size=(10,1))],
            [sg.Input(key='-EDIT_EVENT_PLAYERS-', enable_events=True, border_width=0, expand_x=True)],
            [sg.Input(key='-EDIT_EVENT_ENEMY_PLAYERS-', enable_events=True, border_width=0, size=(10,1))],
            [sg.Input(key='-EDIT_EVENT_START_ZONE-', enable_events=True, border_width=0, size=(10,1))],
            [sg.Input(key='-EDIT_EVENT_END_ZONE-', enable_events=True, border_width=0, size=(10,1))],
            [sg.Input(key='-EDIT_EVENT_START_CAUSE-', enable_events=True, border_width=0, size=(10,1))],
            [sg.Input(key='-EDIT_EVENT_END_CAUSE-', enable_events=True, border_width=0, size=(10,1))],
            [
